...
class BrowserWorkflowNLP:
    ...
    def _looks_browserish(
        ...
        *,
        ...
        lowered = message.lower()
        browser_verbs = ("open", "search", "find", "play", "watch", "login", "log in", "sign in", "switch", "download")
    ...
    async def _classify_with_llm(
        ...
        *,
        ...
        prompt = "\n".join(
            [
                ...
                (
                    ...
                    "github_issue_compose, site_login_then_continue, browser_continue_last_task, none."
                ),
        ...
        try:
            ...
            return None
        if recipe_name == "none" or confidence < float(self.config.browser_workflows.classifier_confidence_threshold):
            return None
